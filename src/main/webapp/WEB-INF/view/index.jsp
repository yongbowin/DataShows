					...
					<div class="row">
						...
						<div id="title02" class="col-xs-12 col-sm-12 col-md-6 panel-top panel-bottom">
							<div class="data-box1 box1-back" id="box02">
								...
								<ul class="data-box1-data clearfix" style="margin-top: 3%;">
									<li class="data-box1-font1">截止目前数字档案系统共收录</li>
									<li class="data-box1-panel">19461</li>
									<li class="data-box1-font1">卷（份）档案</li>
								</ul>
								<%--<div class="total-mn">
									<span>近一年档案数量</span>
						...
						<div id="title03" class="col-xs-12 col-sm-12 col-md-3">
							...
							<div class="data-box1" id="box04" style="margin-top: 30px;">
								...
								<%--<ul class="data-box1-data clearfix">
									...
									<li class="data-box1-panel">19461</li>
									<li class="data-box1-font1">份</li>
								</ul>--%>
								<%--<div class="total-mn">
									<span>占比</span>
								</div>--%>
								<ul class="data-box1-data clearfix" style="margin-top: 3%;">
									<p class="data-box1-font1">合同签订数量达6862次</p>
								</ul>
